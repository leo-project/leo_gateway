...
get_node_status() ->
    ...
    {ok, [{type,          gateway},
          ...
          {watchdog,
           [{cpu_enabled,    ?env_watchdog_cpu_enabled(leo_gateway)},
            {io_enabled,     ?env_watchdog_io_enabled(leo_gateway)},
            {rex_interval,   ?env_watchdog_rex_interval(leo_gateway)},
            {cpu_interval,   ?env_watchdog_cpu_interval(leo_gateway)},
            {io_interval,    ?env_watchdog_io_interval(leo_gateway)},
            {rex_max_mem_capacity, ?env_watchdog_max_mem_capacity(leo_gateway)},
            {cpu_max_cpu_load_avg, ?env_watchdog_max_cpu_load_avg(leo_gateway)},
            {cpu_max_cpu_util,     ?env_watchdog_max_cpu_util(leo_gateway)},
            {io_max_input_per_sec,  ?env_watchdog_max_input_per_sec(leo_gateway)},
            {io_max_output_per_sec, ?env_watchdog_max_output_per_sec(leo_gateway)}
           ]
          },
